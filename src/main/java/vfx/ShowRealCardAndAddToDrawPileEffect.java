// Modification of base game from Fernflower.
...
public class ShowRealCardAndAddToDrawPileEffect extends AbstractGameEffect {
    ...
    public ShowRealCardAndAddToDrawPileEffect(AbstractCard srcCard, float x, float y, boolean randomSpot, boolean cardOffset, boolean toBottom) {
    ...
    public ShowRealCardAndAddToDrawPileEffect(AbstractCard srcCard, float x, float y, boolean randomSpot, boolean cardOffset) {
        this(srcCard, x, y, randomSpot, cardOffset, false);
    }

    public ShowRealCardAndAddToDrawPileEffect(AbstractCard srcCard, float x, float y, boolean randomSpot) {
        this(srcCard, x, y, randomSpot, false);
    }

    public ShowRealCardAndAddToDrawPileEffect(AbstractCard srcCard, boolean randomSpot, boolean toBottom) {
        this.randomSpot = false;
        this.cardOffset = false;
        this.card = srcCard;
        this.duration = 1.5F;
